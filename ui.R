...
fluidPage(theme=shinythemes::shinytheme("cosmo"),
  ...
  mainPanel(
    ...
    conditionalPanel(condition="input.Page==1",
         ...
         and Bruce A. Craig Ph.D. (<a href=http://www.stat.purdue.edu/people/faculty/bacraig>http://www.stat.purdue.edu/people/faculty/bacraig</a>); with advice from John Turnidge Ph.D.")),br(),
