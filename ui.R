  ...
  conditionalPanel(condition="input.Page==2",
    tabsetPanel(
       ...
       tabPanel("Assess uncertainty in estimate", list(br(),
                 verbatimTextOutput("bootERB"),plotOutput("bootPlot",width="800px",height="600px")),value=3),
  ...
  conditionalPanel(condition="input.Page==3",
       tabsetPanel(
         tabPanel("Logistic Model",br(), list(p(strong("This function will take several minutes to run.")),
                  ...
                  plotOutput("logisticPlot",width = "800px", height = "600px"),br(),
                  plotOutput("plotLogisticDensity",width = "800px", height = "600px")),value=2),
         tabPanel("Spline Model",br(), list(p(strong("This function will take several minutes to run.")),
                   br(),
                   verbatimTextOutput("spline"),
                   plotOutput("splinePlot",width = "800px", height = "600px"),br(),
                   plotOutput("plotSplineDensity",width = "800px", height = "600px")),value=3),
         tabPanel("Compare Model Fits", list(br(),
                   verbatimTextOutput("compareFits"),
                   plotOutput("compareFitsPlot",width = "800px", height = "800px")),value=4),
         tabPanel("DIA Classification Probability", list(
                 ...
                 plotOutput("probDIAPlot",width = "800px", height = "600px"),br(),
